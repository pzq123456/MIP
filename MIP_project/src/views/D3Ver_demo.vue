            ...
            <el-dropdown-menu>
              ...
              <el-dropdown-item>Action 5</el-dropdown-item>
                ...
                <el-main class="container2-main">
                    ...
                    <div class="container2-main-main">中间内容</div>
                    <div id="drawer-right">
                    ...
                    <!-- <el-button type="primary" style="margin-left: 16px" @click="isOpenDrawerL">
                        打开左侧抽屉
                    </el-button>
                     <el-button type="primary" style="margin-left: 16px" @click="isOpenDrawerR">
                            打开右侧抽屉
                        </el-button> -->
