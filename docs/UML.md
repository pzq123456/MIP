...
## 四、实验成果
## 五、实验总结
在本实验中，我学会了使用 UML 来设计软件系统，学会了用例图、类图、状态图来描述系统的静态结构和动态行为，学会了使用 Draw.io 及 Visio 来绘制 UML 图。在实验过程中，我遇到了很多问题，比如在绘制类图时，我不知道如何表示泛化关系，后来通过查阅资料，我知道了泛化关系是用空心三角形加实线箭头表示的。在绘制状态图时，我不知道如何表示状态转移，后来通过查阅资料，我知道了状态转移是用实线箭头表示的。通过本次实验，我对 UML 有了更深入的了解。
