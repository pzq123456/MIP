...
## 实验心得
### 潘志清
在本次实验中，我掌握了前后端分离的开发模式，学会了使用Vue框架进行前端开发，学会了使用Flask框架进行后端开发，学会了使用MySQL数据库进行数据存储，学会了使用Docker进行部署。在本次实验中，我主要负责前端的开发，我在本次实验中遇到了很多问题，比如说在前端开发中，我遇到了组件之间的通信问题，我通过查阅资料，最终解决了这个问题。同时，我学会了项目管理、甘特图、流程图及架构图的设计。